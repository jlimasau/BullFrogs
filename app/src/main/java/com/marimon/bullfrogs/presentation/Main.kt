package com.marimon.bullfrogs.presentation
...
import com.marimon.bullfrogs.R
import com.marimon.bullfrogs.databinding.ActivityMainBinding
...
class Main : AppCompatActivity() {
    ...
    val ambientCallback = object : AmbientLifecycleObserver.AmbientLifecycleCallback {
        override fun onEnterAmbient(ambientDetails: AmbientLifecycleObserver.AmbientDetails) {
            ...
            //Toast.makeText(this@Main, "enter ambient", Toast.LENGTH_SHORT).show()
            handleScreenOff()
        ...
        override fun onExitAmbient() {
            ...
            //
            //Toast.makeText(this@Main, "exit ambient", Toast.LENGTH_SHORT).show()
        ...
        override fun onUpdateAmbient() {
            ...
            //Toast.makeText(this@Main, "update ambient", Toast.LENGTH_SHORT).show()

            onUpdate()
        }
    }

    private val ambientObserver = AmbientLifecycleObserver(this@Main, ambientCallback)
...
*/
        ...
        nebulizer.setOnClickListener {
            ...
            if (funnyvar3) {
                ...
                sharedPreferences.edit().putString("modeVar", "sublime mode issue count: ").commit()
                turnOffMode(10)
        ...
        ticket.setOnClickListener {
            ...
            if (giggle1) {
                ...
                //todo double test sharedpref
                froggle(0)
                sharedPreferences.edit().putInt("toggle", 0).commit()
...
/*        phoneButton.setOnClickListener {
  ...
  /*   phoneButton.setOnLongClickListener {
   ...
   /*  modesButton.setOnClickListener {
     ...
     var pageNum = sharedPreferences.getInt("pageNum", 0)
     ...
     QQTS.setOnClickListener {
         pageNum = sharedPreferences.getInt("pageNum", 0)
         pageNum++
         if(pageNum >=11){
             pageNum = 0
         }

         //Toast.makeText(this, pageNum.toString(), Toast.LENGTH_SHORT).show()

         froggle(pageNum)


         sharedPreferences.edit().putInt("pageNum", pageNum).commit()
/*         if (toggle2 == 0) {
             froggle(4)
         } else if (toggle2 == 1) {
             froggle(11)
      ...
      /*   if(onetime1 == 0){
         ...
         lifecycleScope.launch {
             ...
             sharedPreferences.edit().putInt("pageNum", 0).commit()
         }
         onetime1 = 1}*/
     /*   *//* *//*
        ...
        var menu = findViewById<RelativeLayout>(R.id.menu)
        var menu1 = findViewById<ListView>(R.id.menu1)


        var menu2 = mutableListOf<String>()



        menu2.add(0,"Quick Ticket Buttons")
        menu2.add(1,"Quick Buttons")
        menu2.add(2,"Quick Buttons 2")
        menu2.add(3,"Quick Buttons 3")
        menu2.add(4,"Extra Buttons")
        menu2.add(5,"Button List")
        menu2.add(6,"Modes")
        menu2.add(7,"Log")
        menu2.add(8,"Reviews")
        menu2.add(9,"Backup list")
        menu2.add(10,"Settings")
        menu1.adapter = ArrayAdapter<String>(this, R.layout.custom_list2, R.id.custom_text, menu2)


        menu1.setOnItemClickListener { parent, view, position, id ->
            toggle2 = position
        ...
        QQTS.setOnLongClickListener { view ->
            clean()
...
*/
     ...
     //add calendar and numbers to quick search buttons in bsl
     ...
     bsl.setOnItemLongClickListener { parent, view, position, id ->
         ...
         var elipsis = findViewById<TextView>(R.id.elipsis)
         elipsis.setOnClickListener {
         ...
         var star1 = findViewById<TextView>(R.id.star1)
         star1.setOnClickListener() {
             if (bslist.get(position).contains("☆")) {
                 Toast.makeText(this, "☆", Toast.LENGTH_SHORT).show()
         ...
         var resolved = findViewById<TextView>(R.id.resolved)
         resolved.setOnClickListener() {
             if (bslist.get(position).contains("☑")) {
                 Toast.makeText(this, "unresolved", Toast.LENGTH_SHORT).show()
...
*/
     ...
     searchList1.setOnItemLongClickListener { parent, view, position, id ->
         Toast.makeText(this, "perform", Toast.LENGTH_SHORT).show()
         performClickByText(bsl, searchList2.get(position).toString())
     ...
     var elipsis1 = findViewById<TextView>(R.id.elipsis1)
     elipsis1.setOnClickListener {
         searchList2.clear()
         for (i in 0..bslist.size - 1) {
     ...
     var star2 = findViewById<TextView>(R.id.star2)
  ...
  /*       sharedPreferences.edit().remove(position.toString() + "bml").commit()
     ...
     var buttonColor = findViewById<TextView>(R.id.buttonColor)
     buttonColor.setOnClickListener(){
         ...
         var toggle3 = sharedPreferences.getInt("toggle3", 1)

         if(toggle3 == 1) {
             Toast.makeText(this, "lime", Toast.LENGTH_SHORT).show()
             sharedPreferences.edit().putInt("toggle3", 2).commit()
         }
         else if (toggle3 == 2) {
             Toast.makeText(this, "orange", Toast.LENGTH_SHORT).show()
             sharedPreferences.edit().putInt("toggle3", 3).commit()
             //todo make one color invisible
         }
         else if(toggle3 == 3) {
             Toast.makeText(this, "blue", Toast.LENGTH_SHORT).show()
             sharedPreferences.edit().putInt("toggle3", 1).commit()
         }
         setButtonColor()
     }
     setButtonColor()
//todo create top button color changer in the feature
 ...
 fun setButtonColor(){
     ...
     //todo toggle
     //todo set sharedpref to remember change

     if(toggle3 == 1) {


         Q1v.setBackgroundResource(R.drawable.bleh)
         Q2v.setBackgroundResource(R.drawable.bleh)
         Q3v.setBackgroundResource(R.drawable.bleh)
         Q4v.setBackgroundResource(R.drawable.bleh)
         Q5v.setBackgroundResource(R.drawable.bleh)
         Q6v.setBackgroundResource(R.drawable.bleh)
         Q7v.setBackgroundResource(R.drawable.bleh)
         Q8v.setBackgroundResource(R.drawable.bleh)
         Q9v.setBackgroundResource(R.drawable.bleh)
         Q10v.setBackgroundResource(R.drawable.bleh)
         Q11v.setBackgroundResource(R.drawable.bleh)
         Q12v.setBackgroundResource(R.drawable.bleh)
         Q13v.setBackgroundResource(R.drawable.bleh)
         Q14v.setBackgroundResource(R.drawable.bleh)
         Q15v.setBackgroundResource(R.drawable.bleh)
         Q16v.setBackgroundResource(R.drawable.bleh)
         Q17v.setBackgroundResource(R.drawable.bleh)
         Q18v.setBackgroundResource(R.drawable.bleh)
     }
         ...
         Q1v.setBackgroundResource(R.drawable.lime)
         Q2v.setBackgroundResource(R.drawable.lime)
         Q3v.setBackgroundResource(R.drawable.lime)
         Q4v.setBackgroundResource(R.drawable.lime)
         Q5v.setBackgroundResource(R.drawable.lime)
         Q6v.setBackgroundResource(R.drawable.lime)
         Q7v.setBackgroundResource(R.drawable.lime)
         Q8v.setBackgroundResource(R.drawable.lime)
         Q9v.setBackgroundResource(R.drawable.lime)
         Q10v.setBackgroundResource(R.drawable.lime)
         Q11v.setBackgroundResource(R.drawable.lime)
         Q12v.setBackgroundResource(R.drawable.lime)
         Q13v.setBackgroundResource(R.drawable.lime)
         Q14v.setBackgroundResource(R.drawable.lime)
         Q15v.setBackgroundResource(R.drawable.lime)
         Q16v.setBackgroundResource(R.drawable.lime)
         Q17v.setBackgroundResource(R.drawable.lime)
         Q18v.setBackgroundResource(R.drawable.lime)
         //todo make one color invisible
     }
         ...
         Q1v.setBackgroundResource(R.drawable.orange)
         Q2v.setBackgroundResource(R.drawable.orange)
         Q3v.setBackgroundResource(R.drawable.orange)
         Q4v.setBackgroundResource(R.drawable.orange)
         Q5v.setBackgroundResource(R.drawable.orange)
         Q6v.setBackgroundResource(R.drawable.orange)
         Q7v.setBackgroundResource(R.drawable.orange)
         Q8v.setBackgroundResource(R.drawable.orange)
         Q9v.setBackgroundResource(R.drawable.orange)
         Q10v.setBackgroundResource(R.drawable.orange)
         Q11v.setBackgroundResource(R.drawable.orange)
         Q12v.setBackgroundResource(R.drawable.orange)
         Q13v.setBackgroundResource(R.drawable.orange)
         Q14v.setBackgroundResource(R.drawable.orange)
         Q15v.setBackgroundResource(R.drawable.orange)
         Q16v.setBackgroundResource(R.drawable.orange)
         Q17v.setBackgroundResource(R.drawable.orange)
         Q18v.setBackgroundResource(R.drawable.orange)
     }
 }
...
*/
     ...
     var searchList1 = findViewById<ListView>(R.id.searchlist1)
     var menu1 = findViewById<RelativeLayout>(R.id.menu)
...
//if onresume was just turned on set dontdouble to true
         ...
         //return quick button to first toggle
         ...
         dateTime.visibility = View.VISIBLE
         toggle = sharedPreferences.getInt("toggle", 0)
         froggle(toggle)
 ...
 private fun froggle(toggle: Int) {
    ...
    /* if (toggle == ) {
         ...
         guide.setOnClickListener{
          ...
          //Toast.makeText(this, "toggle: " + toggle.toString(), Toast.LENGTH_SHORT).show()
     if (toggle == 0){
 ...
 fun performClickByText(list1: ListView, text1: String) {
     Toast.makeText(this, "clickbytext", Toast.LENGTH_SHORT).show()

     var bsl = findViewById<ListView>(R.id.bsl)

     val adapter = list1.adapter as? ArrayAdapter<String> ?: return
     //Toast.makeText(this, "adapter", Toast.LENGTH_SHORT).show()

     //find position
     val position = bslist.indexOfFirst { it == text1 }
    // Toast.makeText(this, position.toString(), Toast.LENGTH_SHORT).show()
    // Toast.makeText(this, text1, Toast.LENGTH_SHORT).show()
     ...
     if(position!= null && position != -1) {
                 ...
                 bsl.smoothScrollToPosition(position)
                 //Toast.makeText(this, "scroll and click", Toast.LENGTH_SHORT).show()

                // bsl.performItemClick( list1.getChildAt(position - list1.firstVisiblePosition),position, list1.adapter.getItemId(position))

         val listener = bsl.onItemLongClickListener
         if (listener != null) {
             listener.onItemLongClick(bsl, list1.getChildAt(position - list1.firstVisiblePosition),position, list1.adapter.getItemId(position))
         }
